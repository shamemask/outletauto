        ...
        <><div class="content-wrapper">
            <div class="container">
                <ul class="breadcrumb">
                    ...
                    <li class="active"><span>Текущая страница</span></li>
                </ul>
                <div class="content tab-wrapper">
                    <div class="col">
                        <div class="mobile-tab-interface tab-interface">
                            <a href="#" class="catalog-link btn-active tab-btn" data-tab="1">По авто</a>
                            <a href="#" class="catalog-link tab-btn" data-tab="2">По параметрам</a>
                        </div>
                        <div class="tab col tab-active">
...
export default CatalogPersonalAccount