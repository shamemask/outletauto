...
const _Balance = (props) => {
    return (
        <>
            <div class="content-wrapper balance">
            <div class="container">
                <div class="content">
                    <div class="balance-wrapper">
                        <div class="balance-card-wrapper">
                            <span class="balance-title">Баланс</span>
                            <div class="balance-card">
                                <div class="check">
                                    <span>На счету</span>
                                    <span>10 000 руб</span>
                                </div>
                                <button class="red-btn">Пополнить</button>
                            </div>
                        </div>
                        <div class="balance-card-wrapper">
                            <span class="balance-title">Бонусный баланс</span>
                            <div class="balance-card">
                                <div class="check">
                                    <span>На счету</span>
                                    <span>300 руб</span>
                    ...
                    <div class="history-wrapper">
                        <div class="history-header">
                            <span class="history-header-title">История операций</span>
                            <div class="data">
                        ...
                        <div class="history-content">
                            <span class="empty">Транзакции за указанный период отсутствуют</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="balance-warning">
                    ...
                    <div class="warning-info">
                        ...
                        <p>Предложение оплатить заказ переводом на банковскую карту частного лица или по номеру
                            электронного кошелька не являются предложением нашей компании, а принадлежат возможным
                            мошенническим схемам, со всеми вытекающими из этого последствиями. </p>
                    </div>
                </div>
            </div>
        </div>
