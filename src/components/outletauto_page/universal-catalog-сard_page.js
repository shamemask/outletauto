const UniversalCatalogСardPage = (props) => {
    return (
                ...
                <div class="content">
                    <div class="card-product">
                        <div class="image-wrapper">
                            <img src={require("../../assets/imgs/accessories.png")} alt="" class="image" />
                        </div>
                    ...
                    <div class="reviews">
                        ...
                        <div class="comment comment-parent">
                            ...
                            <div class="answer">
                                <div class="comment comment-parent">
                                    <div class="comment-info">
                                        <span class="name">Сергей Викторович <span class="city">(Нижний
                                            Тагил)</span></span>
                                        <div class="inf">
                                            <span class="data">25.03.2021</span><span class="time">10:50</span>
                                        </div>
                        ...
                        <div class="stars-review">
                            ...
                            <ul class="stars-bar">
                                <li><span class="bar-name">5 звёзд</span>
                                    <div class="star-bar">
                                        <div class="progress"></div>
                                    </div><span class="star-num">58</span>
                                </li>
                                <li><span class="bar-name">4 звёзды</span>
                                    <div class="star-bar">
                                        <div class="progress"></div>
                                    </div><span class="star-num">5</span>
                                </li>
                                <li><span class="bar-name">3 звёзды</span>
                                    <div class="star-bar">
                                        <div class="progress"></div>
                                    </div><span class="star-num">3</span>
                                </li>
                                <li><span class="bar-name">2 звёзды</span>
                                    <div class="star-bar">
                                        <div class="progress"></div>
                                    </div><span class="star-num">0</span>
                                </li>
                                <li><span class="bar-name">1 звёзды</span>
                                    <div class="star-bar">
                                        <div class="progress"></div>
                                    </div><span class="star-num">2</span>
                                </li>
                            </ul>
...
export default UniversalCatalogСardPage