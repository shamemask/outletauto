        ...
        <div class="container">
            <div class="offer-content">
                <div class="content-wrapper">
                    <h1 class="title">{props.message} <br /> OutletAuto</h1>
                    <div class="w-100">
                            ...
                            <div class="left-content">
                                <div class="content-search-wrapper">
                                    <form class="content-search search" action="#">
                                        ...
                                        <Link to="/catalog" class="search-btn red-btn">Найти</Link>
                                    </form>
                                    <div class="example">
